...
## Project Structure
    ...
    ├── kus_local_react_nati_7526  # Django project configurations
...
1. Clone this repo and `cd kus_local_react_nati_7526`
...
2. Clone this repo and `cd kus_local_react_nati_7526`
